...
<div style="margin:auto;"><font style=""font-size:0.8em; color:red;"></font></div>
	          ...
	          <img class="logo" src="cloud.png" alt="logo" height="10px" width="10px"/>
						<h2>Oh no! You have wandered very far from the bar.</h2>
					...
					<div class="container-login100-form-btn">
						<h5>Barty will guide you back!</h5>
					</div>
				...
				<div class="login100-more" style="background-image: url('images/BartyError.jpg');"></div>
			</div>
		</div>
	</div>
